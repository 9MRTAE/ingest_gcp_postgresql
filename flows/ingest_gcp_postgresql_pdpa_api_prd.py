"""
Flow  : ingest_gcp_postgresql_pdpa_api_prd
Repo  : ingest_gcp_postgresql_ecoapp
DB    : GCP · PostgreSQL · your-db-hostname · pdpa_api_prd

GCS output path:
    {bucket}/gcp-storage-parquet/pdpa_api_prd/postgresql/{table}/
    calendar_year=YYYY/month_no=M/day_of_month=D/

Run all tables (normal / scheduled):
    python flows/ingest_gcp_postgresql_pdpa_api_prd.py

Repair single table:
    python flows/ingest_gcp_postgresql_pdpa_api_prd.py --table consent_versions
    python flows/ingest_gcp_postgresql_pdpa_api_prd.py --table consent_versions --backdate -3
    python flows/ingest_gcp_postgresql_pdpa_api_prd.py --table consent_versions --startdate 2024-01-01 --enddate 2024-01-31
"""
...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME         = 'pdpa_api_prd'
GCS_APPLICATION = 'pdpa'   # TODO: fill in GCS application folder name
