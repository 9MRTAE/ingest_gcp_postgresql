...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME   = 'announcement_announcement_api_prd'
GCS_APPLICATION = 'announcementv2' # maps to gcp-storage-parquet/{GCS_APPLICATION}/postgresql/{table}/... existing folder in GCS bucket
FLOW_NAME = f'ingest_{PLATFORM}_{DB_TYPE}_{DB_NAME}'   # ingest_gcp_postgresql_auth_api_prd
