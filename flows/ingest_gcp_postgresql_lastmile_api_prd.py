...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME   = 'lastmile_api_prd'
GCS_APPLICATION = 'lastmilev2' # maps to gcp-storage-parquet/{GCS_APPLICATION}/postgresql/{table}/... existing folder in GCS bucket
FLOW_NAME = f'ingest_{PLATFORM}_{DB_TYPE}_{DB_NAME}'   # ingest_gcp_postgresql_ivote_ivote_api_prd
...
TABLE_REGISTRY: dict[str, dict] = {
    ...
    'customer_parcel_canceled_reason': {
        'p_createdate': 'created_date',
        'p_updatedate': 'updated_date',
    },
    'customer_parcel_history': {
        'p_createdate': 'created_date',
        'p_updatedate': 'updated_date',
    },
    'customer_parcel' : {
