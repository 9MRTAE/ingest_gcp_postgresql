...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME   = 'b2b_auth_api_prd'
GCS_APPLICATION = 'b2bauthapi' # maps to gcp-storage-parquet/{GCS_APPLICATION}/postgresql/{table}/... existing folder in GCS bucket
