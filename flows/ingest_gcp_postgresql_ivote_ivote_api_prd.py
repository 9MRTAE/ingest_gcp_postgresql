...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME   = 'ivote_ivote_api_prd'
GCS_APPLICATION = 'ivote' # maps to gcp-storage-parquet/{GCS_APPLICATION}/postgresql/{table}/... existing folder in GCS bucket
...
TABLE_REGISTRY: dict[str, dict] = {
    'agenda': {
        'p_createdate': 'created_time',
        'p_updatedate': 'updated_time',
    },
    'alembic_version': {
        'p_createdate': '',
        'p_updatedate': '',
