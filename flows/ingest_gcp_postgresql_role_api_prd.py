"""
Flow  : ingest_gcp_postgresql_role_api_prd
Repo  : ingest_gcp_postgresql_ecoapp
DB    : GCP · PostgreSQL · your-db-hostname · role_api_prd

GCS output path:
    {bucket}/gcp-storage-parquet/role_api_prd/postgresql/{table}/
    calendar_year=YYYY/month_no=M/day_of_month=D/

Run all tables (normal / scheduled):
    python flows/ingest_gcp_postgresql_role_api_prd.py

Repair single table:
    python flows/ingest_gcp_postgresql_role_api_prd.py --table UnitPermissionQr
    python flows/ingest_gcp_postgresql_role_api_prd.py --table UnitPermissionQr --backdate -3
    python flows/ingest_gcp_postgresql_role_api_prd.py --table UnitPermissionQr --startdate 2024-01-01 --enddate 2024-01-31
"""
...
# ── Identity ──────────────────────────────────────────────────────────────────
DB_NAME         = 'role_api_prd'
GCS_APPLICATION = 'residentpermission'   # TODO: fill in GCS application folder name
