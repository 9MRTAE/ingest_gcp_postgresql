"""
Flow  : ingest_gcp_postgresql_subscription_api_prd
Repo  : ingest_gcp_postgresql_ecoapp
DB    : GCP · PostgreSQL · your-db-hostname · subscription_api_prd

GCS output path:
    {bucket}/gcp-storage-parquet/subscription_api_prd/postgresql/{table}/
...
Repair single table:
    ...
    python flows/ingest_gcp_postgresql_subscription_api_prd.py --table payment_receipts --startdate 2024-01-01 --enddate 2024-01-31
"""
